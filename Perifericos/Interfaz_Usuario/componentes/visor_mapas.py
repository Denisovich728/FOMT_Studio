...
class VisorMapas(QWidget):
    ...
    def _setup_ui(self):
        ...
        tools_layout.addWidget(QLabel("Modo de edición:"))
        tools_layout.addWidget(self.tabs_edit_mode)
        ...
        tools_layout.addWidget(self.btn_resize)
    ...
    def _re_render_tileset(self):
        ...
        if ts_img:
            ...
            img_data = ts_img.tobytes("raw", "RGB")
            qim = QImage(img_data, ts_img.width, ts_img.height, ts_img.width * 3, QImage.Format.Format_RGB888)
