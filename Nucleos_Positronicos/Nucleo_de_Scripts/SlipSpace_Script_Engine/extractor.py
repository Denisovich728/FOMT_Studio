...
from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.cli import build_library_scope
...
def _decompile_worker(args):
    ...
    try:
        from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.cli import decode_script, decompile_instructions, format_script
        from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.decompiler.decorator import decorate_stmts_with_strings
        from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.decompiler.error import DecompileError
...
def extract_all_resources(rom_path: str, output_dir: str, library_path: str = None, update_callback=None):
    ...
    if library_path and os.path.exists(library_path):
        try:
            ...
            from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.ast import NameRefFunc, NameRefProc
    ...
    from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.ir import CallId, CallableShape, ValueType
    ...
    from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.cli import get_all_scripts
    ...
    # Detección adaptativa de hilos (v3.7.0)
    ...
    from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.utility.scan_tables import scan_fomt_tables
    ...
    from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.utility.scan_player import scan_player_stats
    try:
