...
try:
    from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.bytecode.decoder import decode_script, disassemble, get_code_jumps
    from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.ir import *
    from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.decompiler.ins_decompiler import decompile_instructions
    from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.decompiler.formatter import format_script
    from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.decompiler.decorator import decorate_stmts_with_strings, decorate_stmts_with_items, decorate_stmts_with_characters, decorate_stmts_with_flags
...
class FoMTEventParser:
    ...
    def compile_text_to_bytecode(self, text, item_map=None, old_size=0):
        ...
        """
        from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.compiler.lexer import Lexer
        from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.compiler.parser import Parser
        from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.compiler.emitter import compile_script
        from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.bytecode.encoder import encode_script
        from Nucleos_Positronicos.Nucleo_de_Scripts.SlipSpace_Script_Engine.compiler.emitter import ConstScope
