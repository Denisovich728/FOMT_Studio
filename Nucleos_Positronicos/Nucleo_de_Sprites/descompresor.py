...
from Banco_de_Datos.Utilidades.compression import decompress_lz10
from Banco_de_Datos.Utilidades.arcano_marvelous_unpacker import arcano_marvelous_unpack

def descomprimir_rom(proyecto, offset):
    """
    Subrutina Maestra de Descompresión (LZ77 BIOS y ArcanoMarvelous).
    ...
    if header == 0x10:
        ...
        # ArcanoMarvelous Engine (Compresión personalizada de FoMT)
        raw_data = proyecto.read_rom(offset, 0x20000)
        data, _, _ = arcano_marvelous_unpack(raw_data)
    else:
