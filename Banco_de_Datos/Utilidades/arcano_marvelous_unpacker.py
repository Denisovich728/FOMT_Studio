...
def arcano_marvelous_unpack(data):
    """
    Descompresor personalizado para el motor ArcanoMarvelous (FoMT).
    ...
    # El algoritmo ArcanoMarvelous es una variante de LZ con bits de control
