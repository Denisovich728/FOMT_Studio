...
from porpurri.cli import build_library_scope
...
def _decompile_worker(args):
    ...
    try:
        from porpurri.cli import decode_script, decompile_instructions, format_script
        from porpurri.decompiler.decorator import decorate_stmts_with_strings
        from porpurri.decompiler.error import DecompileError
...
def extract_all_resources(rom_path: str, output_dir: str, library_path: str = None, update_callback=None):
    ...
    if library_path and os.path.exists(library_path):
        try:
            ...
            from porpurri.ast import NameRefFunc, NameRefProc
    ...
    from porpurri.ir import CallId, CallableShape, ValueType
    ...
    from porpurri.cli import get_all_scripts
    ...
    from porpurri.utility.scan_tables import scan_fomt_tables
    ...
    from porpurri.utility.scan_player import scan_player_stats
    try:
