...
class Parser:
    ...
    def parse_stmt(self) -> Stmt:
        ...
        raise ParseError(f"Unexpected token {t.type} starting statement at line {t.line}")
    ...
    def parse_program(self, const_scope: 'ConstScope', allow_scripts=True):
        ...
        while self.peek().type != TokenType.EOF:
            ...
            if t.type == TokenType.KW_CONST:
                ...
                compiled = compile_script(block, const_scope)
                scripts.append((val.value, name, compiled))
            else:
